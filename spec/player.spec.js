describe('Player', function () {
    ...
    describe('rowComps,', function () {
        it('returns the rowComponents claimed by the player', function () {
            Board.nodesByRow(myBoard)(3).map(Player.claim(dick));
            Board.nodesByRow(myBoard)(5).map(Player.claim(dick));
    ...
    describe('colComps,', function () {
        it('returns the rowComponents claimed by the player', function () {
            Board.nodesByColumn(myBoard)(3).map(Player.claim(dick));
            Board.nodesByColumn(myBoard)(5).map(Player.claim(dick));
    ...
    describe('posComps,', function () {
        it('returns the rowComponents claimed by the player', function () {
            Board.nodesByColumn(myBoard)(3).map(Player.claim(dick));
            Board.nodesByRow(myBoard)(5).map(Player.claim(dick));
            Board.nodesByPVector(myBoard)(3, 5).map(Player.claim(dick));
    ...
    describe('negComps,', function () {
        it('returns the rowComponents claimed by the player', function () {
            Board.nodesByColumn(myBoard)(3).map(Player.claim(dick));
            Board.nodesByRow(myBoard)(5).map(Player.claim(dick));
            Board.nodesByNVector(myBoard)(3, 5).map(Player.claim(dick));
